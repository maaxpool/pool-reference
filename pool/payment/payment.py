...
class Payment:
    def __init__(self, config: Dict, constants: ConsensusConstants, pool_store: Optional[AbstractPoolStore] = None):
        ...
        self.heart_beat_monitor_url = pool_config["heart_beat_monitor_url_payment"]
        self.heart_beat_interval = int(pool_config.get("heart_beat_interval_payment", "30"))
    ...
    async def submit_payment_loop(self):
        while True:
            try:
                ...
                blockchain_fee: uint64 = uint64(1 * len(payment_targets))
